...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_DRILL_MACHINE_U
  // Description: Drill Machine with four 200 step/rev motors (Z-doubled).
  #define MICROSTEPS_XY 8
  #define STEP_REVS_XY 200
  #define MM_PER_REV_XY 8 // Leadscrew 8mm -- 8mm revs step
  #define MICROSTEPS_Z 8
  #define STEP_REVS_Z 200
  #define MM_PER_REV_Z 2 // Leadscrew 8mm -- 2mm revs step
  #define DEFAULT_X_STEPS_PER_MM (MICROSTEPS_XY*STEP_REVS_XY/MM_PER_REV_XY)
  #define DEFAULT_Y_STEPS_PER_MM (MICROSTEPS_XY*STEP_REVS_XY/MM_PER_REV_XY)
  #define DEFAULT_Z_STEPS_PER_MM (MICROSTEPS_Z*STEP_REVS_Z/MM_PER_REV_Z)
  ...
  #define DEFAULT_Z_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 230.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 240.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 90.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 10000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
